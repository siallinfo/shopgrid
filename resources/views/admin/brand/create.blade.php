                    ...
                    <div class="card">
                        <div class="card-body p-4">
                            <div class="d-flex justify-content-between">
                                <h5 class="mb-4">Add Brand Form</h5>
                                <div>
                                    <a href="{{route('brand.index')}}" class="btn btn-sm btn-primary" title="Manage"><i class='bx bx-wrench'></i></a>
                                </div>
                            </div>
                            ...
                            <form action="{{route('brand.store')}}" method="POST" class="row g-3" enctype="multipart/form-data">
                                ...
                                <div class="col-md-12">
                                    <div class="d-md-flex d-grid align-items-center gap-3">
                                        <button type="submit" class="btn btn-primary px-4">Create New Brand</button>
                                    </div>
                                </div>
                            </form>
                        </div>
