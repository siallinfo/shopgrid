                    ...
                    <div class="card">
                        <div class="card-body p-4">
                            <div class="d-flex justify-content-between">
                                <h5 class="mb-4">Add Category Form</h5>
                                <div>
                                    <a href="{{route('category.index')}}" class="btn btn-sm btn-primary" title="Manage"><i class='bx bx-wrench'></i></a>
                                </div>
                            </div>
                            ...
                            <form action="{{route('category.store')}}" method="POST" class="row g-3" enctype="multipart/form-data">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" name="name" id="input1" placeholder="Category Name">
                                </div>
                                <div class="col-md-12">
                                    <label for="input2" class="form-label">Category Description</label>
                                    <textarea name="description" class="form-control" placeholder="Category Description" id="" cols="30" rows="5"></textarea>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="d-md-flex d-grid align-items-center gap-3">
                                        <button type="submit" class="btn btn-primary px-4">Create New Category</button>
                                    </div>
                                </div>
                            </form>
                        </div>
