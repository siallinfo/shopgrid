                ...
                <div class="col-xl-6 mx-auto">
                    ...
                    <div class="card">
                        <div class="card-body p-4">
                            ...
                            <form action="{{route('category.update', ['id' => $category->id])}}" method="POST" class="row g-3" enctype="multipart/form-data">
                                @csrf
                                <div class="col-md-12">
                                    <label for="input1" class="form-label">Category Name</label>
                                    <input type="text" class="form-control" value="{{$category->name}}" name="name" id="input1" placeholder="Category Name">
                                </div>
                                <div class="col-md-12">
                                    <label for="input2" class="form-label">Category Description</label>
                                    <textarea name="description" class="form-control" placeholder="Category Description" id="" cols="30" rows="5">{{$category->description}}</textarea>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="d-md-flex d-grid align-items-center gap-3">
                                        <button type="submit" class="btn btn-primary px-4">Update Category Info</button>
                                    </div>
                                </div>
                            </form>
                        </div>
