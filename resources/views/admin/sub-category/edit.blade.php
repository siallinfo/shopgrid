                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Edit Sub-Category Form</li>
                        </ol>
                    </nav>
                </div>
                <div class="ms-auto">
                ...
                <div class="col-xl-6 mx-auto">
                    ...
                    <div class="card">
                        <div class="card-body p-4">
                            ...
                            <form action="{{route('sub-category.update', ['id' => $sub_category->id])}}" method="POST" class="row g-3" enctype="multipart/form-data">
                                @csrf
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" value="{{$sub_category->name}}" name="name" id="input1" placeholder="Sub-Category Name">
                                </div>
                                <div class="col-md-12">
                                    <label for="input2" class="form-label">Sub-Category Description</label>
                                    <textarea name="description" class="form-control" placeholder="Sub-Category Description" id="" cols="30" rows="5">{{$sub_category->description}}</textarea>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="d-md-flex d-grid align-items-center gap-3">
                                        <button type="submit" class="btn btn-primary px-4">Update Sub-Category Info</button>
                                    </div>
                                </div>
                            </form>
                        </div>
